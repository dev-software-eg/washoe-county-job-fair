...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-brand-blue px-6 pt-15 pb-15 sm:px-30 lg:px-16 lg:pt-15">
      ...
      <div className="mx-auto max-w-6xl lg:pr-72">
        <div className="max-w-2xl">
          ...
          {/* Remove register - might add back in for a different fucntion later */}
          {/* <a
            href="#"
      ...
      <div className="hidden lg:absolute lg:top-10 lg:-right-1 lg:block lg:w-72 md:absolute md:top-10 md:-right-1 md:block md:w-72">
        <Image
          src={signPostImage}
